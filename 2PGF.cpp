 ...
 /*
  * What does chi depend on?
  * NumberOfPoints[z]	Probably, an amount of points for a given zone for a Markov chain 
  * K_max[z] 
  * ewt[kk][W2], ewt_[][] Probably exp(i Omega Tau ) and its conjugate
  * M[z][j][i]
  * curr_sgn
  * prev_weight
  */
